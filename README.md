...
This repository is used to store the code for the [Commerce Testing documentation](https://developer.adobe.com/commerce/testing/) website. It is built using the [Adobe Edge Delivery Services](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/edge-delivery/overview) and deployed to [Adobe Developer](https://developer.adobe.com/commerce/testing/).

This site contains the latest Adobe Commerce and Magento Open Source testing documentation, including guides for unit testing, integration testing, static analysis, JavaScript testing, and the Functional Testing Framework (MFTF).
